# -*- coding: utf-8 -*-
#
# CPS Search Highlighting documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 07 Jan 2015 15:13:16 +0100.
#
...
project = u'CPS Search Highlighting'
copyright = u'2015, Roman Ott @ CPS It GmbH'
...
htmlhelp_basename = 'cps_searchhighlightdoc'
...
latex_documents = [
    ('Index', 'cps_searchhighlight.tex', u'CPS Search Highlighting',
     u'Roman Ott @ CPS It GmbH', 'manual'),
]
...
pdf_documents = [
    ('Index', 'cps_searchhighlight', u'CPS Search Highlighting',
     u'Roman Ott @ CPS It GmbH'),
]
...
texinfo_documents = [
    ('Index', 'cps_searchhighlight', u'CPS Search Highlighting',
     u'Roman Ott @ CPS It GmbH', 'CPS Search Highlighting', 'One line description of project.',
     'Miscellaneous'),
]
