...
class tx_formhandler_module1 extends \TYPO3\CMS\Backend\Module\BaseScriptClass {
	...
	function main()	{
		...
		if (($this->id && $access) || ($GLOBALS['BE_USER']->user['admin'] && !$this->id))	{
			...
			//$headerSection = $this->doc->getHeader('pages',$this->pageinfo,$this->pageinfo['_thePath']).'<br />'.$GLOBALS['LANG']->sL('LLL:EXT:lang/locallang_core.xml:labels.path').': '.\TYPO3\CMS\Core\Utility\GeneralUtility::fixed_lgd_cs($this->pageinfo['_thePath'],50);
