...
console.log('using Google password strategy');
...
requirejs([], function() {
    ...
    var GOOGLE_CLIENT_ID = "893117143428-dpfsru1cj4u1o64gscager715leddi27.apps.googleusercontent.com";
    var GOOGLE_CLIENT_SECRET = "VTfxqlEb4U2KP6372yundnyT";
    ...
    passport.use(new GoogleStrategy({
        ...
        process.nextTick(function() {
            ...
            // want
            // to associate the Google account with a user record in your
            // database,
